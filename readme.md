...
# 📊 Dashboard Page 1 — Executive Overview (نمای کلی مدیریتی)

## 🎯 هدف صفحه

این صفحه برای مدیران ارشد (CEO و مدیران اجرایی) طراحی شده است. هدف آن ارائه مهم‌ترین شاخص‌های عملکرد کسب‌وکار در **کمتر از ۱۰ تا ۱۵ ثانیه** است تا مدیر بتواند در یک نگاه وضعیت کلی فروش، درآمد، رضایت مشتریان و روند کسب‌وکار را ارزیابی کند.
